        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#0c0c0e] text-zinc-300 p-6">
            <div className="w-full max-w-md bg-zinc-900/50 p-8 rounded-3xl border border-zinc-800 shadow-2xl">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-black text-white tracking-tighter uppercase">Create <span className="text-amber-500">Account</span></h1>
                    <p className="text-zinc-500 text-sm mt-2">Join the professional audio community</p>
                </div>
